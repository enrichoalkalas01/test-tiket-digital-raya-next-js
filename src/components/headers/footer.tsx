    ...
    return (
        ...
        <div className="container mx-auto px-4">
            ...
            <div>
                ...
                <p className="text-gray-300">Portal film terlengkap dengan koleksi terbaru dan klasik dari seluruh dunia.</p>
            </div>
            
            <div>
                <h4 className="text-lg font-semibold mb-3">Kategori</h4>
                ...
                <li><a href="#" className="text-gray-300 hover:text-white">Horror</a></li>
            ...
            <div>
                ...
                <li><a href="#" className="text-gray-300 hover:text-white">Film Terbaru</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">Top Rated</a></li>
                <li><a href="#" className="text-gray-300 hover:text-white">Jadwal Rilis</a></li>
            ...
            <div>
                ...
                <ul className="space-y-2">
                <li className="text-gray-300">info@moviemania.com</li>
                <li className="text-gray-300">+62 123 4567 890</li>
            ...
            <p>&copy; 2025 MovieMania. Semua hak cipta dilindungi.</p>
            </div>
        </div>
        </footer>
    );
